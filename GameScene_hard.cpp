...
SceneBase* GameSceneHard::Update(float _deltaTime)
{
...
void GameSceneHard::Load()
{
	...
	for (int i = 0; i < (enemyNum + 1); i++)
	{
		...
		//	rand = (float)GetRand(10000) / 50000.0f;
		//	m_target[i]->SetAccel(rand);
		//}
		//if (rand <= 0.02f)
		//{
